    ...
    return (
      <>
        <Box
          ...
          data-bs-scroll="true" tabIndex="-1" id="dime-explanation-canvas"
          aria-labelledby="offcanvasWithBothOptionsLabel"
          sx={{ width: this.props.width }}
        >
          <Box className="offcanvas-header">
            <h5 className="offcanvas-title" id="offcanvasWithBothOptionsLabel">Explanation</h5>
          ...
          <Box className="offcanvas-body scroll-hidden">
            <Box className="row align-items-md-stretch">
              <Box className="h-100 p-5 shadow material-blue">
                ...
                <p>This version of DIME Server supports Rasa 2.8.X. models only.</p>
                <p>Sample Config[]</p>
              </Box>
              {/* <Chip
            label="Generated"

...
export default class ExplanationListItem extends Component {
  render() {
    return (
      <Box key={this.props.explanationName}>
        <ListItem className="w-100 app-model-list-item">
          ...
          {this.props.originChip && (
            <Chip label="Uploaded" color="success" className="material-green" />
          )}
          <Box className="d-none d-md-block">
            <Stack direction="row" spacing={1} className={"float-end"}>
              <Button
                ...
                onClick={(e) => {
                  this.props.handleVisualize(e, this.props.explanationName);
                }}
              >
                Visualize
              </Button>
              <Button
                ...
                onClick={(e) => {
                  this.props.handleDownload(e, this.props.explanationName);
                }}
              >
                Download
              </Button>
